...
invoked by the CEO role after the diagnostic-test-writer role reports a
failure. Your job is to determine who owns the fix - not to fix it yourself.
...
4. The failing test output from the diagnostic-test-writer role.
