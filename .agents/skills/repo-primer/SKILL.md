...
3. Inspect execution-critical config files for stack and tooling (`pyproject.toml`, `package.json`, lockfiles, framework/build/test/lint configs, `docker-compose.yml`, CI/deploy configs).
