...
5. Add AI-facing guidance only where useful:
...
6. Report created docs, updated docs, assumptions, unresolved gaps, and recommended follow-up validations.

## Baseline Documents
- `README.md`: purpose, quick start, core commands, repo map, links to durable docs.
- `docs/architecture.md`: system context, runtime flow, major boundaries, integrations, constraints, risks/debt.
- `docs/development.md`: setup, local run, test/lint/build commands, common workflows, troubleshooting.
